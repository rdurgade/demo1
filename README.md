...
```sh
$ cd $GOPATH/src
$ git clone https://github.com/opsinfra/demo1.git
```
...
4. Replace name demo1 in main.go with new project name
```sh
Example:
    $ cd $GOPATH/src/mysvc
    $ sed -i '' "s/demo1/${PWD##*/}/g" main.go  # On Linux, this line would be sed -i main.go "s/demo1/${PWD##*/}/g"
```
